...
import { River } from '../water/RiverPage';
...
function MobileHome() {
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ref={containerRef}
        className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-desktop"
        style={{
...
function DesktopHome() {
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ref={containerRef}
        className="relative w-full h-screen overflow-hidden bg-desktop"
        style={{
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          userSelect: 'none',
