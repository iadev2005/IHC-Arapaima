...
export function Culture() {
    ...
    const filteredArticles = useMemo(() => {
        if (selectedLabel === 'Todos') return articlesData;
        return articlesData.filter((a) => a.label === selectedLabel);
    }, [selectedLabel]);
        ...
        <AnimatePresence mode="wait">
            ...
            >
                ...
                >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pt-32 md:pt-52 overflow-hidden">
                                        ...
                                        {filteredArticles.length === 0 ? (
                                            ...
                                            <>
                                                <div
                                                    ...
                                                    onClick={() => navigate(`/article/${articlesData.indexOf(currentArticle)}`)}
                                                >
