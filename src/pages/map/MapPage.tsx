    ...
    return (
        ...
        >
            ...
            {/* Contenido con altura adaptativa */}
                                    <div className="h-[40vh] md:h-[500px] overflow-y-auto pr-2 md:pr-4 scrollbar-gold">
        ...
        <AnimatePresence mode="wait">
            ...
            >
                ...
                >
                    ...
                    <div className="relative flex-1 overflow-y-auto scrollbar-gold pt-28 md:pt-36">
